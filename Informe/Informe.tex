...
\begin{enumerate}
	...
	un modelo lineal dado por \ref{eqn:sistPequeniasDesviaciones} alrededor de puntos de operación definidos por \ref{eqn:equilibrioDinamicoSistema} con estado inicial genérico.
