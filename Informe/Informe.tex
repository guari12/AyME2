...
Trubii
Una de las técnicas mas usadas para estimar una variable de estado que no puede ser sensada y digitalizada, es implementar a nivel controlador un observador. El mismo es capaz de estimar las variables de estado internas de un sistema dinámico que no son accesibles físicamente.
