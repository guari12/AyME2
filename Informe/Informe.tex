...
\begin{enumerate}
	...
	\begin{equation}
		...
		\begin{cases}
			...
			\\
			\\
			\Delta\omega_{m}(t)=\frac{\frac{3}{2} \cdot P_{p} \cdot \left [ \lambda_{m}^{r'}+\left ( L_{d}-L_{q} \right )\cdot i_{ds}^{r} \left ( t \right ) \right ] \cdot i_{qs}^{r}\left ( t \right )-b_{eq}\cdot \omega_{m}\left ( t \right )-T_{eq}}{J_{eq}}
			\\
			\\
